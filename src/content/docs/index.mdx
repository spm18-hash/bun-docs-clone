...
parentDirectory: Welcome to Bun
tableOfContents: false
hero:
  title: Welcome to Bun
  tagline: Bun is an all-in-one toolkit for developing modern JavaScript/TypeScript applications.
  image:
...
<CardGrid>
  ...
  <Card
    ...
    icon="box"
    href="/package-manager/core-commands/bun-install/"
  >
    Install packages up to 30x faster than npm with a global cache and
    workspaces
    <Fragment slot="text-with-link">
  ...
  <Card
    ...
    icon="flask-conical"
    href="/test-runner/getting-started/test-runner/"
  >
  ...
  <Card title="Bun Bundler" icon="combine" href="/bundler/core/">
...
<CardGrid>
  <Card title="Install Bun" icon="download" href="/get-started/installation/">
...
- **Node.js compatibility**. In addition to supporting Node-style module resolution, Bun aims for full compatibility with built-in Node.js globals (`process`, `Buffer`) and modules (`path`, `fs`, `http`, etc.) This is an ongoing effort that is not complete. Refer to the [compatibility page](/runtime/standards-compatibility/nodejs-compatibility/) for the current status.
